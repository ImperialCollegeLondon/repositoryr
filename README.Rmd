...
- A `filename.R` file will be created under the `R/` directory which you can populate (In this case, as an example, it is populated with a function to add two numbers). 
